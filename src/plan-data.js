...
// Week 1 begins on this Monday. All workout dates derive from it.
// Weeks run Monday->Sunday to match Strava's weekly boundaries, which also
// keeps Sat+Sun back-to-back long runs on consecutive days.
export const PLAN_START = "2026-07-13"; // Mon Jul 13 2026
...
export const WEEKS = [
  {
    n: 1, dates: "Jul 13 – Jul 19", phase: "reintro", miles: 32, longRun: "12mi easy",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "5mi easy + gym upper + backward treadmill walk 5 min" },
      { day: "Thu", type: "mid", desc: "6mi easy on soft surface if possible" },
      { day: "Fri", type: "gym", desc: "4mi easy + gym (hip abduction/adduction)" },
  ...
  {
    n: 2, dates: "Jul 20 – Jul 26", phase: "reintro", miles: 38, longRun: "15mi easy",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "6mi easy + gym upper + backward walk" },
  ...
  {
    n: 3, dates: "Jul 27 – Aug 2", phase: "build", miles: 44, longRun: "16mi",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "9mi easy + gym upper + backward walk" },
      { day: "Thu", type: "easy", desc: "6mi easy" },
      { day: "Fri", type: "gym", desc: "Gym + mobility (no running — legs fresh for Sat)" },
  ...
  {
    n: 4, dates: "Aug 3 – Aug 9", phase: "build", miles: 48, longRun: "18mi",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "8mi easy + gym upper" },
      { day: "Thu", type: "easy", desc: "8mi easy" },
      { day: "Fri", type: "gym", desc: "Gym (no running — legs fresh for Sat)" },
  ...
  {
    n: 5, dates: "Aug 10 – Aug 16", phase: "build", miles: 38, longRun: "14mi",
    ...
    workouts: [
      ...
      { day: "Tue", type: "easy", desc: "6mi easy" },
      { day: "Wed", type: "gym", desc: "6mi easy + gym upper" },
      { day: "Thu", type: "mid", desc: "7mi easy" },
      { day: "Fri", type: "gym", desc: "5mi easy + gym stretch" },
  ...
  {
    n: 6, dates: "Aug 17 – Aug 23", phase: "build", miles: 52, longRun: "B2B: 20+12",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "7mi easy + gym upper" },
  ...
  {
    n: 7, dates: "Aug 24 – Aug 30", phase: "peak", miles: 56, longRun: "B2B: 22+16",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "4mi easy + gym light" },
      { day: "Thu", type: "mid", desc: "8mi easy" },
  ...
  {
    n: 8, dates: "Aug 31 – Sep 6", phase: "peak", miles: 44, longRun: "18mi",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "7mi easy + gym" },
      { day: "Thu", type: "mid", desc: "7mi easy" },
      { day: "Fri", type: "gym", desc: "7mi easy + gym stretch" },
  ...
  {
    n: 9, dates: "Sep 7 – Sep 13", phase: "peak", miles: 60, longRun: "B2B: 22+18",
    ...
    workouts: [
      ...
      { day: "Tue", type: "easy", desc: "5mi easy" },
      { day: "Wed", type: "gym", desc: "7mi easy + gym light" },
      { day: "Thu", type: "mid", desc: "8mi easy" },
      { day: "Fri", type: "rest", desc: "Rest" },
  ...
  {
    n: 11, dates: "Sep 21 – Sep 27", phase: "peak", miles: 48, longRun: "B2B: 18+14",
    focus: "Final quality block before taper. Lower than peak, still race-specific. Then we back off.",
    workouts: [
      { day: "Mon", type: "gym", desc: "Rehab + legs" },
      { day: "Tue", type: "easy", desc: "5mi easy" },
      { day: "Wed", type: "gym", desc: "3mi easy + gym" },
  ...
  {
    n: 12, dates: "Sep 28 – Oct 4", phase: "taper", miles: 40, longRun: "16mi",
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "6mi easy + gym" },
      { day: "Thu", type: "mid", desc: "7mi moderate" },
      { day: "Fri", type: "gym", desc: "5mi easy + gym light" },
  ...
  },
  {
    ...
    workouts: [
      ...
      { day: "Wed", type: "gym", desc: "4mi easy + gym stretching focus" },
      { day: "Thu", type: "easy", desc: "4mi easy" },
      { day: "Fri", type: "easy", desc: "3mi easy" },
  ...
  {
    n: 14, dates: "Oct 12 – Oct 18", phase: "taper", miles: 18, longRun: "8mi",
    ...
    workouts: [
      ...
      { day: "Thu", type: "easy", desc: "3mi easy shakeout" },
  ...
  {
    n: 15, dates: "Oct 19 – Oct 25", phase: "race", miles: 102, longRun: "100mi RACE",
